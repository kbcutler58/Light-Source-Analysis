...
% 
% datafiles = dir('Ab Results/*waves01*.mat');
% for i = 1:29
%     cd('C:\Users\Kyle\Downloads\DOSI data for wv LG testing')
%     dir_string = strcat('Ab Results/*waves',num2str(i,'%02d'),'*.mat');
...
%     plot(wvs(domain),muaOld(r,domain),'r',wvs(domain),muaNew(r,domain),'b',wvs(domain),muaOldFit(r,domain),'g'),legend('Broadband Fit','Discrete Point Fit','Broadband Conc'), title(titlestring),...
%         xlabel('wavelengths in nm'), ylabel('Mua in 1/mm');
