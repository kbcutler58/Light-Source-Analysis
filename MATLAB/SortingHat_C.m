%% Sorting Hat Script with Analysis (matlab)
...
% % Patient Selction
for patientbatch = patientVariable; % Select Specific Patients% for patientbatch = [1 2 3 6 7 8 9 10 16] %Biceps Select Patients
...
if results == 1
    ...
    Mua_run = [Mua_run muaNew(:,c)];
    Mua_old = [Mua_old muaOld(:,c)];
...
% plot(testwvs(1,:),muaNew(1,c),'*r',testwvs(1,:),muaOld(1,c),'*b')
