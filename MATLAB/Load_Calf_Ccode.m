...
% datafiles = dir('calf6wv/*waves01*.mat');
datafiles = dir('calf4wv/*waves01*.mat');
for i = 1:3
    cd('C:\Users\Kyle\Downloads\c chromophore results\c chromophore results');
%     dir_string = strcat('calf6wv/*waves',num2str(i,'%02d'),'*.mat');
    dir_string = strcat('calf4wv/*waves',num2str(i,'%02d'),'*.mat');
