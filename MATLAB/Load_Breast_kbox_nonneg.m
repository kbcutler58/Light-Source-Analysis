...
datafiles = dir('Breast Results 4wv new nonneg\*waves01.mat');
% datafiles = dir('Breast Results\*waves01.mat');
for i = 1:1
    cd('C:\Users\Kyle\Downloads\DOSI data for wv LG testing')
    dir_string = strcat('Breast Results 4wv new nonneg\*waves',num2str(i,'%02d'),'.mat');
...
%     cd('Breast Results 4wv new')
        cd('Breast Results 4wv new nonneg')
