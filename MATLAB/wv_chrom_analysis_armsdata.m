...
wvlengths = [...
    ...
    testwvs=wvlengths(waves,:);
        ...
        cd 'C:\Users\Kyle\Downloads\DOSI data for wv LG testing\Processed Biceps'
        folders = dir('BicepMeas_150225');
        cd('BicepMeas_150225');
...
%         path1 = 'C:\Users\Kyle\Downloads\DOSI data for wv LG testing\PROCESSED_use these processed data';
        path1='C:\Users\Kyle\Downloads\DOSI data for wv LG testing\Processed Biceps\BicepMeas_150225';
%         k = 1;
...
%                     end
            ...
            OutputFile = strcat(folders(k+2).name,'_waves',num2str(waves,'%02d'),'_Biceps','.mat');
            cd('C:\Users\Kyle\Downloads\DOSI data for wv LG testing\Arm Results 4wv');
